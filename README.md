...
- **聊天截图识别** - 上传聊天截图，AI 自动识别并提取对话内容
- **人物档案管理** - 为重要联系人建立档案，记录性格特点、沟通偏好等信息
...
- **游客模式** - 无需注册即可体验基础功能
- **订阅系统** - 支持 Free/Lite/Pro 三档订阅，满足不同需求
- **数据统计** - 管理员可查看用户使用统计和订阅数据
...
| `/guest` | 游客模式 | 无需登录体验基础功能 | 公开 |
| `/profile` | 人物档案 | 管理联系人档案 | 需登录 |
| `/profile/:id/chat` | 档案聊天 | 基于档案生成回复 | 需登录 |
| `/history` | 历史记录 | 查看所有历史记录（分页）| 需登录 |
| `/favorites` | 收藏 | 查看收藏的回复 | 需登录 |
| `/admin/statistics` | 数据统计 | 查看用户统计数据 | 管理员 |
